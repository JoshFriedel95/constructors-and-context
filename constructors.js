...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  User.prototype.changePostRating = function(id, newRating){
    const indeValue = this.savedPosts.findIndex((ele) => ele.id === id )
    this.savedPosts[indeValue].rating = newRating
  }
